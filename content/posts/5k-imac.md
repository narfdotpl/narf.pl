...
They make me miss the up-arrow: I put my index finger on the left key, ring finger on the right key, and instead of the up-arrow, I hit the shift with my middle finger.  It wouldn't be much of a problem if I didn't have it remapped to be more useful than just shift (TODO: blog about my custom keyboard mappings; 2023 update: [welp][Corne]).
